...
class DateUtilitiesTest {
    ...
    void checkISODate() {
        ...
        //aparte
        assertFalse(DateUtilities.checkISODate("20222-07-35"));
        assertFalse(DateUtilities.checkISODate("2022-076-35"));
        assertFalse(DateUtilities.checkISODate("20222-07-125"));
        assertTrue(DateUtilities.checkISODate("2020-02-29"));
